  ...
  if (isMyTurn) {
    return (
      <div className="flex flex-col items-center gap-4">
        <p className="text-slate-300 text-sm">{t.kingsCup.yourTurn}</p>
        <motion.button
  ...
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      <p className="text-slate-400 text-sm">
        {t.kingsCup.waitingForBefore}{' '}
        <span className="text-white font-semibold">{drawerUsername}</span>{' '}
        {t.kingsCup.waitingForDrawAfter}
      </p>
    </div>
  );
};
