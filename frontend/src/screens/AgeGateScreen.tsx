  ...
  return (
    <div className="app-bg min-h-dvh flex items-center justify-center p-4">
      ...
      >
        ...
        <p className="text-amber-400 font-medium text-sm mb-6">{t.ageGate.tagline}</p>
        ...
        <div className="bg-red-500/10 border border-red-500/20 rounded-2xl p-4 mb-6 text-left">
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-red-300 font-bold text-sm mb-1">{t.ageGate.adultsOnly}</p>
              <p className="text-red-200/70 text-xs leading-relaxed">{t.ageGate.adultsOnlyDesc}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-amber-500/5 border border-amber-500/15 rounded-2xl p-4 mb-6 text-left">
          <div className="flex items-start gap-3">
            ...
            <p className="text-amber-200/60 text-xs leading-relaxed">{t.ageGate.alcoholWarning}</p>
          </div>
        </div>
        ...
        <p className="text-slate-600 text-[11px] mt-4 leading-relaxed">{t.ageGate.disclaimer}</p>
      </motion.div>
    </div>
  );
};
